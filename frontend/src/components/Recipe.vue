<template>
    <div
      ...
      <div class="h-5"></div>
      <!-- Info-Sektion-->
      <div class="bg-white p-8 rounded-xl shadow-md md:p-12 max-w-5xl mx-auto mt-8 dark:bg-[#2C3E50] dark:text-white">
        <div class="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div class="hidden md:block w-px bg-gray-300 h-24 dark:bg-gray-500"></div>
      ...
      <div class="flex gap-6 justify-center mt-12 text-xs">
        <span class="bg-white text-[#4A5759] py-1 px-4 rounded-full shadow-sm border border-[#AEC2AF] dark:bg-[#2C3E50] dark:text-white dark:border-gray-600">#vegan</span>
        <span class="bg-white text-[#4A5759] py-1 px-4 rounded-full shadow-sm border border-[#AEC2AF] dark:bg-[#2C3E50] dark:text-white dark:border-gray-600">#glutenfrei</span>
        <span class="bg-white text-[#4A5759] py-1 px-4 rounded-full shadow-sm border border-[#AEC2AF] dark:bg-[#2C3E50] dark:text-white dark:border-gray-600">#gesund</span>
      </div>
      <div class="h-10"></div>
      ...
      <div class="mt-16 flex flex-col md:flex-row gap-16">
        ...
        <div class="p-8 w-full md:w-1/2 dark:text-white">
          ...
          <div class="flex justify-center mt-8">
            <a href="#" class="bg-[#D4D0C4] text-[#4A5759] font-semibold text-lg py-3 px-8 rounded-full shadow-sm hover:bg-[#4A5759] hover:text-[#D4D0C4] transition duration-300 transform hover:scale-105 dark:bg-[#3E4B4D] dark:text-white dark:hover:bg-[#E89BA7] dark:hover:text-[#4A5759]">
              Weg zur Zubereitung
            </a>
          </div>
        </div>
