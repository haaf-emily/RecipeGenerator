<template>
  <div class="py-10 transition-colors duration-300">
    ...
    <div class="container mx-auto px-6">
      ...
      <div v-else>
        ...
        <div class="bg-[#4A5759] py-6 shadow-md mb-16 w-full dark:bg-[#2C3E50]">
          <h1 class="text-4xl font-bold text-center text-white rounded">Rezept Übersicht</h1>
        </div>
        <div class="h-5"></div>
        ...
        <div v-if="!error" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <!-- Each card is fully clickable - Frühstück Card -->
          <div
            class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform duration-300 dark:bg-[#2C3E50] dark:text-white cursor-pointer"
            @click="navigateTo('./recipe-breakfast')"
          >
            <img
              :src="
            ...
            <div class="p-6">
              ...
              <div
                class="mt-4 text-white bg-primary px-4 py-2 rounded inline-block dark:bg-[#FF6F61]"
              >
                Zum Rezept
              </div>
            </div>
          ...
          <div
            class="bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition-transform duration-300 dark:bg-[#2C3E50] dark:text-white cursor-pointer"
            @click="navigateTo('./recipe-dinner')"
          >
            <img
              :src="
                mealPlanData && mealPlanData.meals
